...
namespace L.R._Gcaleka__Co.Areas.Identity.Pages.Account
{
    ...
    public class RegisterConfirmationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string email, string returnUrl = null)
        {
          ...
          //$"An account with L.R. Gcaleka & Co has been created for you.<br> " +
          //$"Please confirm your email by <a href='{HtmlEncoder.Default.Encode(EmailConfirmationUrl)}'>clicking here</a>.");
